...
INSERT INTO utilisateurs (nom, prenom, email, mot_de_passe, role, code_matricule)
VALUES ('test', 'test', 'test@mail.com', 'test', 'gestionnaire', '123456');

-- Ajouter 20 emplacements de concessionnaire
INSERT INTO emplacements (numero, zone)
VALUES ('none', 'concessionnaire'),
...
VALUES ('Ford', 'Mustang', 2018, 30000.00, 30000, 'disponible', 2),
